...
SELECT
    ...
    sex_male,
    sex_male_moe,
    CAST(sex_male AS BIGNUMERIC) / CAST(sex_total AS BIGNUMERIC) AS pct_sex_male,
    (
    ...
    CAST(
        (
            ...
            sex_male_85_and_over +
            sex_male_85_and_over_moe
        ) AS BIGNUMERIC) / CAST(sex_total AS BIGNUMERIC) AS pct_male_voting_age_population,
    sex_female,
    sex_female_moe,
    CAST(sex_female AS BIGNUMERIC) / CAST(sex_total AS BIGNUMERIC) AS pct_sex_female,
    (
    ...
    CAST(
        (
            ...
            sex_female_85_and_over +
            sex_female_85_and_over_moe
        ) AS BIGNUMERIC) / CAST(sex_total AS BIGNUMERIC) AS pct_female_voting_age_population,
    race_white_total,
    race_white_total_moe,
    CAST(race_white_total AS BIGNUMERIC) / CAST(total_population AS BIGNUMERIC) AS pct_race_white,
    race_black_total,
    race_black_total_moe,
    CAST(race_black_total AS BIGNUMERIC) / CAST(total_population AS BIGNUMERIC) AS pct_race_black,
    race_asian_total,
    race_asian_total_moe,
    CAST(race_asian_total AS BIGNUMERIC) / CAST(total_population AS BIGNUMERIC) AS pct_race_asian,
    race_pacific_islander_total,
    race_pacific_islander_total_moe,
    CAST(race_pacific_islander_total AS BIGNUMERIC) / CAST(total_population AS BIGNUMERIC) AS pct_race_pacific_islander,  -- Corrected column name
    race_other_total,
    race_other_total_moe,
    CAST(race_other_total AS BIGNUMERIC) / CAST(total_population AS BIGNUMERIC) AS pct_race_other,
    race_two_or_more_total,
    race_two_or_more_total_moe,
    CAST(race_two_or_more_total AS BIGNUMERIC) / CAST(total_population AS BIGNUMERIC) AS pct_race_two_or_more,  -- Corrected column name
    hispanic_total,
    hispanic_total_moe,
    CAST(hispanic_total AS BIGNUMERIC) / CAST(total_population AS BIGNUMERIC) AS pct_race_hispanic  -- Corrected column name
